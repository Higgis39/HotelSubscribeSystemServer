...
public class DataFactoryService extends UnicastRemoteObject implements HotelPromotionDataService,BussinessAreaDataService,
	...
	private BussinessAreaDataService bus;
	...
	public ArrayList<BussinessAreaPO> findBussinessAreaByCity(String city) throws RemoteException {
		return bus.findBussinessAreaByCity(city);
	}
}
